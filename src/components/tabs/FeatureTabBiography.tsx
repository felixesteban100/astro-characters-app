...
import { AlignmentTranslator, GetColorLogosByPublisher, getAlignmentIcon, publisherIMG } from "@/lib/charactersUtils"
        ...
        >
            <StatContainer>
                ...
                <div className="flex flex-row justify-between items-center gap-5 my-5">
                    ...
                    <div className="font-bold capitalize"><img alt="publisherLogo" width={50} height={50} className={`h-10 w-auto ${GetColorLogosByPublisher(selectedCharacter.biography.publisher)}`} src={publisherIMG(selectedCharacter.biography.publisher)} /></div>
                </div>
                <Separator />
