...
<script lang="ts">
  ...
  function goPage(
    ...
    // const filter_characters_button = document.getElementById("filter_characters");
    // if (isEnter) filter_characters_button?.click();
...
<div class="h-[850px] w-full overflow-y-scroll">
  ...
  <div class="flex flex-col gap-10">
    ...
    <div class="flex flex-col gap-5">
      ...
      <Label class="flex gap-5 items-center justify-start"
        ><Checkbox bind:checked={includesOrExactState} /> Include charactes in name
        (checked) | Exact name (Unchecked)
      </Label>
    </div>
...
<svelte:window on:keydown={goPage} />
