<script lang="ts">
  ...
  .filter(
    ...
    ;
  const comics = (characterInfoComics && characterInfoComics.length > 0) ? characterInfoComics : (publisherComics && publisherComics.length > 0) ? publisherComics : COMICS_DEFAULT
</script>
